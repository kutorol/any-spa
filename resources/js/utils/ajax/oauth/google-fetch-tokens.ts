...
export class GoogleFetchTokens {
  ...
  public static onSuccess(tokens: Omit<TokenResponse, "error" | "error_description" | "error_uri">, handleReCaptchaVerify: any, chosenRole?: ERoles) {
    new GoogleOAuth(tokens, handleReCaptchaVerify, chosenRole);
  }
