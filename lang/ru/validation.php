...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'bad_title' => 'Название не прошло проверку',
        'latitude_fail' => 'Широта должна быть допустимой координатой широты в десятичном формате (48.8584)',
        'longitude_fail' => 'Долгота должна быть допустимой координатой долготы в десятичном формате (2.2945)',
        'g-recaptcha-token' => [
            'recaptchav3' => 'Ошибка проверки Google каптчи',
        ],
        'integer' => 'Поле :attribute должно быть целым числом и не может быть меньше 0 или больше '.MinMaxInteger::MAX_INT32,
    ],
];
